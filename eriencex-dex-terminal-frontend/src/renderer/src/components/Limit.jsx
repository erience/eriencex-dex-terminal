                      ...
                      <>
                        ...
                        <div className="col-span-12">
                          <div className="relative flex items-center gap-2">
                            {limit.buyTimeInForce == 'IOC' && (
                              <div
                                className={`${limit.buyTimeInForce == 'GTT' ? 'cursor-wait opacity-50' : ''} relative text-white form-control w-1/2`}
                              >
                            ...
                            {limit.buyTimeInForce == 'GTT' && (
                              <div
                                className={`${limit.buyTimeInForce == 'IOC' ? 'cursor-wait opacity-50' : ''} relative text-white form-control w-1/2`}
                              >
