...
try {
    ...
    try {
      ...
      if (index >= 0 && index < jsonData.allGridSettings.length) {
        ...
        if (newLimitOrders.length > 0 || newOrders.length > 0) {
          // console.log("Return From Start GridBot")
          // TODO:
  ...
  printLog("Error in main/index.js", error)
}
